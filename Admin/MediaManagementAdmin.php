...
class MediaManagementAdmin extends BaseAdmin
{
    ...
    public function setRequest(Request $request)
    {
        if (null == $this->cid && null != $request) {
            $this->cid = $request->attributes->get('cid');
        }
    ...
    {
        return parent::generateUrl($name, array_merge($parameters,
            array('cid' => array_key_exists('cid', $parameters) ? $parameters['cid'] : ($this->cid ? $this->cid : 0))
        ), $absolute);
    }
