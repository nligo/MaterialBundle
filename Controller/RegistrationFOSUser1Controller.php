 ...
 */
class RegistrationFOSUser1Controller extends \Application\Sonata\UserBundle\Controller\RegistrationFOSUser1Controller
{
    /**
...
//        @author   coffey  start
//        $user = $this->container->get('fos_user.user_manager')->findUserBy(array('email'=>'qqqq'));
